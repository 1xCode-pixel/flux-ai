...
// ==========================================
// 📊 ЛИМИТЫ (Обновлено: добавлен CODE)
// ==========================================
const LIMITS = {
...
// 2. Модели для Кодинга (Лучшие бесплатные)
const CODE_MODELS = [
    "qwen/qwen-2.5-coder-32b-instruct:free", // Топ для кода
...
`,
    ...
    // --- Новый промт для КОДЕРА (Flux Coder) ---
    CODE_MASTER: `
...
3. СТЕК: Используй современный синтаксис (ES6+, Python 3.11+, React Hooks и т.д.).
4. БЕЗОПАСНОСТЬ: Всегда учитывай уязвимости (SQLi, XSS).
...
async function getUserData(uid) {
    // Добавляем codeCount в дефолтный объект
...
// ==========================================
// 🤖 ЧАТ (С ЛОГИКОЙ КОДЕРА)
// ==========================================
app.post('/api/chat', async (req, res) => {
    // Получаем mode из запроса
    ...
    // 2. Лимиты (Разделение на Code и General)
    if (tier !== 'ADMIN') {
        const now = Date.now();
